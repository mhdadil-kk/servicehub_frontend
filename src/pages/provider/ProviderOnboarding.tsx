  ...
  const handleNext = async () => {
    ...
    try {
      if (currentStep === 1) {
        ...
        // Step 2: Service
        if (!selectedService || !form.hourlyRate) {
          throw new Error("Please select a service and set your hourly rate");
        }
        ...
        // Step 4: Bank Details
        if (!form.accountHolderName || !form.bankName || !form.accountNumber || !form.routingNumber) {
      ...
      if (currentStep < 4) {
        ...
        // Final completion view or redirect
        setProgress(100);
      }
    } catch (error: any) {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2 col-span-1 md:col-span-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-50/50 border border-slate-100 rounded-xl px-4 py-3 text-sm font-semibold focus:outline-none focus:ring-4 focus:ring-blue-600/5 focus:border-blue-600 transition-all" 
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                       <input 
                        ...
                        className="flex-1 bg-slate-50/50 border border-slate-100 rounded-xl px-4 py-3 text-sm font-semibold focus:outline-none focus:ring-4 focus:ring-blue-600/5 focus:border-blue-600 transition-all" 
                       />
                    </div>
                  </div>
                  <div className="space-y-2">
                 ...
                 {(selectedService) && (
                    <div className="space-y-8 pt-12 border-t border-slate-100 animate-in fade-in slide-in-from-top-6 duration-700">
                       ...
                       <div className="max-w-md">
                          <div className="relative group">
                             <span className="absolute left-6 top-1/2 -translate-y-1/2 text-3xl font-black text-slate-300 group-focus-within:text-blue-600 transition-colors">₹</span>
                             <input 
                                type="number" 
                                value={form.hourlyRate}
                                onChange={(e) => setForm({...form, hourlyRate: e.target.value})}
                                placeholder="0" 
                                className="w-full bg-slate-50/50 border-2 border-slate-100 rounded-[32px] pl-14 pr-24 py-8 text-4xl font-black text-slate-900 focus:outline-none focus:ring-8 focus:ring-blue-600/5 focus:border-blue-600 transition-all placeholder:text-slate-200" 
                             />
                          ...
                          <div className="mt-6 flex gap-4 p-5 bg-blue-50/50 rounded-3xl border border-blue-100/50">
                             ...
                             <p className="text-xs font-semibold text-blue-900/60 leading-relaxed">
                                Most professionals in <b>{selectedService.name || 'this category'}</b> set their rates between ₹500 and ₹1,500 based on experience.
                             </p>
                          </div>
                       </div>
                    </div>
                ...
                {[
                  ...
                  <div key={item.num} className="bg-white p-10 rounded-[40px] shadow-sm border border-slate-100 space-y-6">
                    ...
                    <div 
                      ...
                      className="border-2 border-dashed border-slate-100 rounded-[32px] p-12 flex flex-col items-center justify-center text-center space-y-4 hover:border-blue-200 hover:bg-blue-50/30 transition-all cursor-pointer group"
                    >
                        ...
                        <div>
                           ...
                           <p className="text-[10px] font-bold text-slate-300 mt-2 uppercase tracking-widest">PNG, JPG, or PDF (Max 5MB)</p>
                        </div>
                        <button className="bg-white border border-slate-200 px-6 py-2 rounded-xl text-xs font-black text-slate-900 hover:border-blue-600 transition-all">
                           Select Files
                        </button>
                    </div>
                       ...
                       {verificationDocs.map((file, idx) => (
                          <div key={idx} className="bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100 flex items-center gap-2">
                             ...
                             <button 
                                onClick={(e) => {
                                   e.stopPropagation();
                                   setVerificationDocs(prev => prev.filter((_, i) => i !== idx));
                                }}
                    ...
                    <div className="flex-1 space-y-4">
                       ...
                       <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 flex gap-4 cursor-pointer group">
                          ...
                          <p className="text-xs font-semibold text-slate-500 leading-relaxed">
                             ...
                             By checking this box, you agree to our <a href="#" className="text-blue-600 hover:underline">Provider Terms</a> and authorize us to verify your criminal record and professional standing through our third-party partner, Checkr.
                          </p>
                       </div>
                    </div>
                </div>
              ...
              <div className="bg-white p-12 rounded-[40px] shadow-sm border border-slate-100 max-w-2xl mx-auto space-y-8">
                 <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-50/50 border border-slate-100 rounded-xl px-4 py-4 text-sm font-semibold focus:outline-none focus:ring-4 focus:ring-blue-600/5 focus:border-blue-600 transition-all" 
                     />
                 </div>
                 <div className="space-y-2">
